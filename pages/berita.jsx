          ...
          >
            <div class="p-1    row">
              ...
              <div class="col-xl-6 col-lg-6 row justify-content-end">
                ...
                <p class={`${styles.date} text-white`}>
  12 Desember 2021
</p>
                  ...
                  <p class="card-text text-start text-dark justify-center fw-normal col-12 col-md-12 m-0 px-md-3 py-md-2">
                    ...
                    teman-teman sekelas saya. begitupun sebagian besar orang
                    tua, mimpi mereka adalah melihat anaknya kembali ke
                    aktivitas sekolah secara langsung. Orang tua selama ini
                    banyak yang mengaku lelah karena anak-anaknya selama pandemi
                  ...
                  <Link
                    href="/artikel"
                    class=" fw-semibold col-12 m-0 px-3 py-2 mb-md-3"
                    style={{ color: "#4FACF6" }}
                  >
                    Baca selengkapnya
                  </Link>
